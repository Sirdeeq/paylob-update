...
const WhyPaylobDropdown = () => {
  return (
    <div className="absolute top-full left-0 bg-white shadow-lg rounded-md py-4 w-64 lg:w-[32rem] z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 px-4">
        ...
        {/* Left-hand side: 5 items */}
        <ul>
          <div className="border-t border-gray-200 my-2 lg:my-0"></div>
